hash =
    ...
    "number_of_followers"=>3590,
    "number_of_friends"=>699,
    "latest_tweet"=>
     "RT @chrisccerami: While learning web development I created a map of all of the shows @Screamales have played and damn @DonGiovanniRecs http…",
    "number_of_tweets"=>1433,
    "location"=>"Boston, MA"
 ...
 "dpickett"=>
   {"description"=>"Co-Founder at @LaunchAcademy_, Co-Organizer of @bostonrb",
    ...
    "number_of_followers"=>1604,
    "number_of_friends"=>874,
    "latest_tweet"=>
     "RT @MeetingBoy: If your employees worked until 3AM, you have failed as a manager.",
    "number_of_tweets"=>3451,
 ...
 "chrisccerami"=>
   {"description"=>
    ...
    "number_of_friends"=>81,
    "latest_tweet"=>
     "@dongiovannirecs @screamales here's where it's hosted right now if you want to check out the interactive map https://t.co/NkgVIXNPxf",
    "number_of_tweets"=>1815,
 ...
 "spencercdixon"=>
   {"description"=>
    ...
    "number_of_followers"=>952,
    "number_of_friends"=>141,
    "latest_tweet"=>"So pumped for snowboarding tomorrow!",
    "number_of_tweets"=>149,
    "location"=>"Boston, MA"},
 "corinnebabbles"=>
   {"description"=>
    ...
    "last_twenty_tweets"=>
     ["How many new supporters do you think this led to? - Protests on I-93 Cause Major Traffic Delays; 17 Arrested http://t.co/L1XqhUZRdm",
      ...
      "Or shrinking seats?"],
    "number_of_followers"=>369,
    "number_of_friends"=>439,
    "latest_tweet"=>
     "How many new supporters do you think this led to? - Protests on I-93 Cause Major Traffic Delays; 17 Arrested http://t.co/L1XqhUZRdm",
    "number_of_tweets"=>299,
    "location"=>"Boston, MA"},
 "dot_the_speck"=>
   {"description"=>nil,
    "last_twenty_tweets"=>
    ...
    "number_of_friends"=>84,
    "latest_tweet"=>"@lizvdk You are awesome! It will all be good!",
 ...
 "bostonrb"=>
   {"description"=>
    ...
    "number_of_followers"=>2169,
    "number_of_friends"=>9,
    "latest_tweet"=>
     "RT @sarahmei: I had a great time @bostonrb! I'm honored to be a Weirich Fellow. Hope my talk lived up to the legacy. See you again in warme…",
    "number_of_tweets"=>1645,
    "location"=>"Boston, MA"},
 "judngu"=>
   {"description"=>
 ...
 "lizvdk"=>
   {"description"=>
    ...
    "number_of_followers"=>60,
    "number_of_friends"=>234,
    "latest_tweet"=>
     "@chrisccerami I may be able to have both but for now I pick visualizations.",
    "number_of_tweets"=>228,
    "location"=>"Boston, MA"},
 "hchood"=>
   {"description"=>
    ...
    "number_of_followers"=>242,
    "number_of_friends"=>832,
    "latest_tweet"=>
     "@bcardarella no problem, thanks for the great walk-through!",
    "number_of_tweets"=>207,
    "location"=>"Cambridge, MA"},
 "wand_chris"=>
   {"description"=>nil,
    "last_twenty_tweets"=>
 ...
 "julissaJM"=>
   {"description"=>
    ...
    "number_of_followers"=>587,
    "number_of_friends"=>577,
    "latest_tweet"=>
     "RT @YearlyAwards: We've named @JulissaJM our Least Acrimonious Tweeter of 2014!",
    "number_of_tweets"=>11542,
    "location"=>"Boston, Ma"},
 "ashleytbasinger"=>
   {"description"=>
    ...
    "number_of_followers"=>83,
    "number_of_friends"=>188,
    "latest_tweet"=>
     "Listening to Dashboard all morning. I think today is going to be awesome. #dashboardconfessional #deskconfessional",
    "number_of_tweets"=>352,
    "location"=>"Boston"},
 "alacritythief"=>
   {"description"=>
    ...
    "number_of_followers"=>63,
    "number_of_friends"=>47,
    "latest_tweet"=>
     "Hey @TobitronKahn ! Send me an email to alacritystudios@gmail.com and I'll be happy to answer any questions you may have.",
    "number_of_tweets"=>222,
    "location"=>"Boston, MA"
    }
  }
  
# Each username followed by its description. If there is no description (i.e., nil then print out "NA" instead):
hash.each do |username, info|
  if info["description"].nil?
  puts "#{username}: NA"
  else puts "#{username}: #{info["description"]}"
  end
end
# Each username followed by total number_of_followers:
hash.each do |username, info|
  puts "#{username}: #{info["number_of_followers"]}"
end
# Each username and the length of their latest_tweet:
hash.each do |username, info|
  puts "#{username}'s latest tweet was #{info["latest_tweet"].length} characters long."
end
# Each username followed by the total character count used in that user's last_twenty_tweets:
hash.each do |username, info|
  puts "#{username} used #{info["last_twenty_tweets"][0].length} characters in their last twenty tweets."
end
# Which user has the most followers?
puts hash.max_by {|username, info| info["number_of_followers"]}[0]
# Which user has the most friends?
puts hash.max_by {|username, info| info["number_of_friends"]}[0]
# Which user has the greatest number_of_tweets?
puts hash.max_by {|username, info| info["number_of_tweets"]}[0]
# Which users have a description listed in twitter_data?
hash.each do |username, info|
unless info["description"].nil?
  puts username
  end
end
